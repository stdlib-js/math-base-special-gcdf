...
function g(e,r){var i=0,t;if(e===0)return r;if(r===0)return e;for(;!(e&1)&&!(r&1);)e>>>=1,r>>>=1,i+=1;for(;!(e&1);)e>>>=1;for(;r;){for(;!(r&1);)r>>>=1;e>r&&(t=r,r=e,e=t),r-=e}return e<<i}f.exports=g
